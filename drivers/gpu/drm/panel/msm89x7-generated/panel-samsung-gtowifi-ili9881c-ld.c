...
static inline struct ili9881c_ld *to_ili9881c_ld(struct drm_panel *panel)
{
	return container_of_const(panel, struct ili9881c_ld, panel);
}

static void ili9881c_ld_reset(struct ili9881c_ld *ctx)
{
...
static int ili9881c_ld_on(struct ili9881c_ld *ctx)
{
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x0f, 0x1e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x10, 0x1e);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x51, 0x32);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x52, 0x54);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x53, 0x76);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x54, 0x98);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x55, 0xba);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x56, 0x10);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x57, 0x32);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x58, 0x54);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x59, 0x76);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x5a, 0x98);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x5b, 0xba);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x5c, 0xdc);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x5d, 0xfe);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x61, 0x15);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x62, 0x14);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x67, 0x06);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x6e, 0x07);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x84, 0x07);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x6e, 0x2a);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x6f, 0x35);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x3a, 0x24);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x8d, 0x1f);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb5, 0x27);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x31, 0x75);
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x31, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x53, 0x63);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x55, 0x69);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x50, 0xc7);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x51, 0xc2);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x60, 0x26);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x63, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa0, 0x08);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa1, 0x0f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa2, 0x25);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa3, 0x01);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa4, 0x23);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa5, 0x18);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa6, 0x11);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa7, 0x1a);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa8, 0x81);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xa9, 0x19);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xaa, 0x26);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xab, 0x7c);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xac, 0x24);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xad, 0x1e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xae, 0x5c);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xaf, 0x2a);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb0, 0x2b);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb1, 0x50);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb2, 0x5c);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xb3, 0x39);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc0, 0x08);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc1, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc2, 0x24);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc3, 0x1d);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc4, 0x04);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc5, 0x32);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc6, 0x24);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc7, 0x1f);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc8, 0x90);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xc9, 0x20);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xca, 0x2c);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcb, 0x82);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcc, 0x19);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcd, 0x22);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xce, 0x4e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xcf, 0x28);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd0, 0x2d);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd1, 0x51);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0xd2, 0x5d);
...
static int ili9881c_ld_off(struct ili9881c_ld *ctx)
{
	struct mipi_dsi_multi_context dsi_ctx = { .dsi = ctx->dsi };
...
static int ili9881c_ld_prepare(struct drm_panel *panel)
{
	struct ili9881c_ld *ctx = to_ili9881c_ld(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;

	ili9881c_ld_reset(ctx);

	ret = ili9881c_ld_on(ctx);
	if (ret < 0) {
...
static int ili9881c_ld_unprepare(struct drm_panel *panel)
{
	struct ili9881c_ld *ctx = to_ili9881c_ld(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;

	ret = ili9881c_ld_off(ctx);
	if (ret < 0)
...
static const struct drm_display_mode ili9881c_ld_mode = {
	.clock = (800 + 52 + 8 + 48) * (1280 + 16 + 6 + 15) * 60 / 1000,
	.hdisplay = 800,
	.hsync_start = 800 + 52,
	.hsync_end = 800 + 52 + 8,
	.htotal = 800 + 52 + 8 + 48,
...
static int ili9881c_ld_get_modes(struct drm_panel *panel,
				 struct drm_connector *connector)
{
	return drm_connector_helper_get_modes_fixed(connector, &ili9881c_ld_mode);
}

static const struct drm_panel_funcs ili9881c_ld_panel_funcs = {
	.prepare = ili9881c_ld_prepare,
	.unprepare = ili9881c_ld_unprepare,
	.get_modes = ili9881c_ld_get_modes,
};

static int ili9881c_ld_probe(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
	struct ili9881c_ld *ctx;
	int ret;

	ctx = devm_drm_panel_alloc(dev, struct ili9881c_ld, panel,
				   &ili9881c_ld_panel_funcs,
...
static void ili9881c_ld_remove(struct mipi_dsi_device *dsi)
{
	struct ili9881c_ld *ctx = mipi_dsi_get_drvdata(dsi);
	int ret;
...
static const struct of_device_id ili9881c_ld_of_match[] = {
	{ .compatible = "samsung,gtowifi-ili9881c-ld" }, // FIXME
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, ili9881c_ld_of_match);

static struct mipi_dsi_driver ili9881c_ld_driver = {
	.probe = ili9881c_ld_probe,
	.remove = ili9881c_ld_remove,
	.driver = {
		.name = "panel-samsung-gtowifi-ili9881c-ld",
		.of_match_table = ili9881c_ld_of_match,
	},
};
module_mipi_dsi_driver(ili9881c_ld_driver);

MODULE_AUTHOR("linux-mdss-dsi-panel-driver-generator <fix@me>"); // FIXME
MODULE_DESCRIPTION("DRM driver for ili9881c_wxga_video_ld");
MODULE_LICENSE("GPL");
